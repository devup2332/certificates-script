...
export const environments = {
  ...
  DATABASE_HOST_VDM: process.env.DATABASE_HOST_VDM || "",
  DATABASE_USER_VDM: process.env.DATABASE_USER_VDM || "",
  DATABASE_PASSWORD_VDM: process.env.DATABASE_PASSWORD_VDM || "",
  DATABASE_NAME_VDM: process.env.DATABASE_NAME_VDM || "",
  DATABASE_HOST_LMS: process.env.DATABASE_HOST_LMS || "",
  DATABASE_USER_LMS: process.env.DATABASE_USER_LMS || "",
  DATABASE_PASSWORD_LMS: process.env.DATABASE_PASSWORD_LMS || "",
  DATABASE_NAME_LMS: process.env.DATABASE_NAME_LMS || "",
